    ...
    <section className="announcement">
        <div className="container">
            ...
            <div className="announcement__bottom">
                <a href="#" className="link link1"><span>Показать все объявления </span>
                ...
                <div className="right-links">
                    <a href="#" className="link"><span> Как подать объявление</span>
                    ...
                    <a href="#" className="link"><span>Добавить свое объявление</span>
