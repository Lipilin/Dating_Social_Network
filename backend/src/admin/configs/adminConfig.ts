    ...
    resources: [
      {
        ...
        options: {
          ...
          editProperties: ['email', 'password', 'name', 'surname', 'description', 'status', 'role', 'avatar', 'banner'],
          actions: {
            new: {
      ...
      },
      {
        ...
        options: {
          ...
          editProperties: ['title', 'description', 'dateFrom', 'dateTo', 'departure', 'destination', 'genderInterest', 'status', 'user', 'interests'],
          properties: {
            user: {
              reference: 'User',
              isVisible: { edit: true, show: true }
